<div class="counter-board-area" data-background="{{$themeAsset->counter}}">
    <div class="container">
        <div class="row wow fadeInUp counter-board-content" style="visibility: visible; animation-name: fadeInUp;">
            <div class="col-lg-3 col-sm-6">
                <div class="counter-board-single mb-40">
                    ...
                    <div class="counter-board-number"><span class="odometer odometer-auto-theme" data-count="30"><div
                                    ...
                                    class="odometer-digit"><span class="odometer-digit-spacer">8</span><span
                                        class="odometer-digit-inner"><span class="odometer-ribbon"><span
                                                class="odometer-ribbon-inner"><span
                                                    class="odometer-value">0</span></span></span></span></span></div></span>K+
                    </div>
                    <p>HAPPY CUSTOMERS</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="counter-board-single mb-40">
                    ...
                    <div class="counter-board-number"><span class="odometer odometer-auto-theme" data-count="90"><div
                                class="odometer-inside"><span class="odometer-digit"><span
                                        class="odometer-digit-spacer">8</span><span class="odometer-digit-inner"><span
                                            class="odometer-ribbon"><span class="odometer-ribbon-inner"><span
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="counter-board-single mb-40">
                    ...
                    <div class="counter-board-number"><span class="odometer odometer-auto-theme" data-count="27"><div
                                class="odometer-inside"><span class="odometer-digit"><span
                                        class="odometer-digit-spacer">8</span><span class="odometer-digit-inner"><span
                                            class="odometer-ribbon"><span class="odometer-ribbon-inner"><span
                                    ...
                                    class="odometer-digit"><span class="odometer-digit-spacer">8</span><span
                                        class="odometer-digit-inner"><span class="odometer-ribbon"><span
                                                class="odometer-ribbon-inner"><span
                                                    class="odometer-value">7</span></span></span></span></span></div></span>K+
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="counter-board-single mb-40">
                    ...
                    <div class="counter-board-number"><span class="odometer odometer-auto-theme" data-count="20"><div
                                class="odometer-inside"><span class="odometer-digit"><span
                                        class="odometer-digit-spacer">8</span><span class="odometer-digit-inner"><span
                                            class="odometer-ribbon"><span class="odometer-ribbon-inner"><span
                                                    class="odometer-value">2</span></span></span></span></span><span
