...
@section('setting_form')
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            ...
            {{ html()->text('recaptcha_site_key', $settings["recaptcha_site_key"] ?? null)->placeholder(__("admin/{$folder}.recaptcha_site_key_placeholder"))->class('form-control') }}
            {{ html()->label(__("admin/{$folder}.recaptcha_secret_key")) }}
            {{ html()->text('recaptcha_secret_key', $settings["recaptcha_secret_key"] ?? null)->placeholder(__("admin/{$folder}.recaptcha_secret_key_placeholder"))->class('form-control') }}
        </div>
        <div class="col-xl-4 col-lg-6">
            <div class="card-title-head">
            ...
            {{ html()->textarea('analytics_code', $settings["analytics_code"] ?? null)->placeholder(__("admin/{$folder}.analytics_code_placeholder"))->class('form-control')->rows(3) }}
        </div>
        <div class="col-xl-4 col-lg-6">
            <div class="card-title-head">
            ...
            {{ html()->textarea('tag_manager_head_code', $settings["tag_manager_head_code"] ?? null)->placeholder(__("admin/{$folder}.tag_manager_head_code_placeholder"))->class('form-control')->rows(3) }}
            {{ html()->label(__("admin/{$folder}.tag_manager_body_code")) }}
            {{ html()->textarea('tag_manager_body_code', $settings["tag_manager_body_code"] ?? null)->placeholder(__("admin/{$folder}.tag_manager_body_code_placeholder"))->class('form-control')->rows(3) }}
        </div>
    </div>
@endsection
